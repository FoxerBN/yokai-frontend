  ...
  return (
    ...
    >
      <div
        ...
        before:bg-black before:opacity-60 before:rounded-xl relative`}
        style={{
          backgroundImage: `url('/images/${category.id}.jpg')`,
        }}
      >
        <div className="text-center relative z-10">
          <h3 className="text-xl font-bold text-white opacity-90 mb-2">
            {category.name}
          </h3>
          <p className="text-sm text-white mb-3 opacity-90">
