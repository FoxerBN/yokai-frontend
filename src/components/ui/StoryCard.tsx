...
const StoryCard: React.FC<StoryCardProps> = ({ article, index }) => {
  ...
  return (
    <div
      className="group bg-gray-800 rounded-xl overflow-hidden shadow-xl transition-all duration-300 transform  border border-transparent hover:border-[0_0_16px_4px_rgba(220,38,38,1)] hover:shadow-[0_0_16px_4px_rgba(220,38,38,0.2)]"
